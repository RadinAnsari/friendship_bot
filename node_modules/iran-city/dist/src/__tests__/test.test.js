...
test('city by ID', () => {
    expect((0, index_1.cityById)(766)).toStrictEqual({
        id: 766,
        name: 'رفسنجان',
        province_id: 21,
        province_name: 'کرمان',
...
test('search by name (not found)', () => {
    expect((0, index_1.searchByName)('رفسنجان')).toStrictEqual(['استان یافت نشد']);
});
test('search by name', () => {
    expect((0, index_1.searchByName)('کرمان')).toStrictEqual([
